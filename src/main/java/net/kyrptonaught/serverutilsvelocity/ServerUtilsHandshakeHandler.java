...
public class ServerUtilsHandshakeHandler {
    ...
    public void onPreLogin(PreLoginEvent event) {
        ...
        conn.sendLoginPluginMessage(ServerUtilsVelocityPlugin.HANDSHAKE_ID, new byte[1], responseBody -> {
    ...
    public void onServerLoginPluginMessage(ServerLoginPluginMessageEvent event) {
        if (event.getIdentifier().equals(ServerUtilsVelocityPlugin.HANDSHAKE_ID)) {
